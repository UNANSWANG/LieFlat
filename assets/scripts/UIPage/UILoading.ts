...
export class UILoading extends Component {
    ...
    loadItems = [UIPath.UIMain, UIPath.UISetting, UIPath.UISkinStore, UIPath.UIStore, UIPath.UIMatch,
    UIPath.UIWarm, UIPath.UIAnnouncement, UIPath.UIMoney, UIPath.UIDifficulty, UIPath.UIRank, UIPath.UIDailyGift];
